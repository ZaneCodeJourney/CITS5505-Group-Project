...
# POST /dives/api/ - Create a new diving record
...
# GET /dives/api/<dive_id> - Retrieve a single dive record
@bp.route('/api/<int:dive_id>', methods=['GET'])
def get_dive(dive_id):
    dive = Dive.query.get_or_404(dive_id)
    return jsonify(dive_to_dict(dive)), 200

# PUT /dives/api/<dive_id> - Update a dive record
@bp.route('/api/<int:dive_id>', methods=['PUT'])
...
# DELETE /dives/api/<dive_id> - Delete a dive record
@bp.route('/api/<int:dive_id>', methods=['DELETE'])
