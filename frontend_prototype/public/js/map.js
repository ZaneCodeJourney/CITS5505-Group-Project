...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ,
        ...
        {
            name: "Kuda Haa - Baa Atoll, Maldives",
            location: [5.1833, 73.0667],
            description: "Pristine thilas with overhangs, caves and abundant reef fish.",
            difficulty: "Beginner to Intermediate",
            visibility: "15-30m",
            depthRange: "5-30m"
        },
        {
            name: "Manta Point - Hanifaru Bay, Maldives",
            location: [5.1500, 73.1500],
            description: "UNESCO Biosphere Reserve famous for manta ray and whale shark aggregations.",
            difficulty: "Beginner",
            visibility: "10-30m",
            depthRange: "5-15m"
        },
    ...
    // Map click event to get coordinates (useful for development)
